...
### Solve
**Flag:** `pwn.college{AZUQVMxdSJmf2nSJHHijMe8NpfF.QXyMDO0wSMzEzNzEzW}`
...
/opt/busybox/busybox-1.33.2/include/config/ash/job/flag
...
hacker@commands~finding-files:~$ cat /opt/busybox/busybox-1.33.2/include/config/ash/job/flag
/opt/pwndbg/.venv/lib/python3.8/site-packages/pwnlib/flag
pwn.college{AZUQVMxdSJmf2nSJHHijMe8NpfF.QXyMDO0wSMzEzNzEzW}bash: /opt/pwndbg/.venv/lib/python3.8/site-packages/pwnlib/flag: Is a directory
```

### New Learnings
i learnt how to find files and ignoring errors that are encountered
